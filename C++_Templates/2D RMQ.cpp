...
// Memory Complexity: O(N^2 * log^2N)
...
int query (int a, int b, int c, int d) {
	...
	return min(min(segmin[SIZE1][a][SIZE2][c], segmin[SIZE1][b - (1 << SIZE1) + 1][SIZE2][c]), min(segmin[SIZE1][a][SIZE2][d - (1 << SIZE2) + 1], segmin[SIZE1][b - (1 << SIZE1) + 1][SIZE2][d - (1 << SIZE2) + 1]));
}
