...
/*
 * If M lines are given, along with Q queries, the overall Tiem Complexity is O((Q + M)logM)
 * Reference: https://wcipeg.com/wiki/Convex_hull_trick
 * Using solution to CCO Preparation Test 3 - Packing Up as code for template
 */
